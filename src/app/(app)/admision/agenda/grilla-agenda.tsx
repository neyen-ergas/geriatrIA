      ...
      {semana.dias.map(dia => {
        ...
        return (
          <section
            ...
            className={
              esHoy ? "rounded-xl border border-sky-300 bg-sky-50/40 p-2 shadow-sm" : ""
            }
          >
              ...
              {(Object.entries(FRANJAS) as [Franja, string][]).map(
                ([franja, etiqueta]) => {
                  ...
                  return (
                    <Card
                      key={franja}
                      className={`min-h-44 p-3 ${visita ? "border-sky-200 bg-sky-50" : "bg-slate-50"}`}
                    >
                      ...
                      {visita ? (
                        <>
                          ...
                          <a
                            ...
                            className="mt-2 block break-all text-sm text-sky-800 underline"
                          >
                            {visita.telefono}
                          </a>
                          <Link
