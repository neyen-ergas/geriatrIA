...
vi.mock("./actions", () => ({
  agendarVisita: vi.fn(),
  cambiarEstado: vi.fn(),
  cancelarVisita: vi.fn(),
  guardarNotas: vi.fn(),
}));
const CONSULTA: Consulta = {
  id: "consulta",
  creado_en: "2026-01-01T12:00:00Z",
  actualizado_en: "2026-01-01T12:00:00Z",
  nombre: "Contacto ficticio",
  telefono: "000000",
  momento_llamado: "manana",
  mensaje: null,
  origen: "web",
  estado: "visita_agendada",
  notas_internas: null,
  visita_fecha: "2026-01-02",
...
it("una consulta vinculada muestra la cuenta y permite notas, sin reabrir", () => {
  const html = renderToStaticMarkup(
    <ConsultaCard consulta={{ ...CONSULTA, estado: "ingreso", ingreso_id: "estadia" }} />,
  );
...
it("Solo lectura conserva notas y visita pero no ofrece mutaciones", () => {
  const html = renderToStaticMarkup(
    <ConsultaCard consulta={{ ...CONSULTA, notas_internas: "Nota ficticia" }} />,
    "readonly",
  );
