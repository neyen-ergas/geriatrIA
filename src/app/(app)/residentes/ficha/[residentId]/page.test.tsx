...
const ficha: FichaResidente = {
  ...
  estadias: {
    ...
    filas: [
      {
        id: "historico",
        admitted_at: "2025-01-02",
        discharged_at: "2025-02-02",
        discharge_reason: "Motivo ficticio",
        room: "1",
        monthly_fee: 100,
        currency: "ARS",
        due_day: 10,
...
it.each(["admin", "management"])(
  "%s gestiona el ingreso activo aunque mire una página antigua",
  async rol => {
