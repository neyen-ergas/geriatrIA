...
const params = Promise.resolve({ residentId: "87000000-0000-4000-8000-000000000010", contactId: "87000000-0000-4000-8000-000000000020" });
beforeEach(() => {
  vi.resetAllMocks(); mocks.datos.mockResolvedValue({ residente: { first_name: "Persona <script>", last_name: "Ficticia" }, contacto: {
    first_name: "Familiar", last_name: "Ficticio", relationship: "Hija", phone: "0000000", notes: null,
    is_emergency_contact: true, is_payment_responsible: false, updated_at: "2026-09-14T12:00:00Z",
  } });
});
it.each([NuevoPage, EditarPage])("exige permiso antes de leer", async pagina => {
  ...
  expect(mocks.sesion).toHaveBeenCalledWith("operational.write"); expect(mocks.datos).not.toHaveBeenCalled();
});
...
it.each([NuevoPage, EditarPage])("persona/contacto inexistente no abre el formulario", async pagina => {
