...
export default async function EditarFamiliarPage({ params }: {
  ...
  return <div className="mx-auto max-w-2xl">
    ...
    <p className="mt-2 text-sm text-slate-600">
      Contacto de {datos.residente.first_name} {datos.residente.last_name}.
      Los cambios actualizan sus datos actuales y quedan en Auditoría.
    </p>
    <FormularioFamiliar residenteId={residentId} contactoId={contactId} contacto={datos.contacto} />
  </div>;
}
