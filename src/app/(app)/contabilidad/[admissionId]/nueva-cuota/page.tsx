  ...
  return (
    <div>
      ...
      <FormularioCarga
        ...
        diaVencimiento={cuenta.due_day}
        volver={`/contabilidad/${admissionId}`}
        formAction={crearCuota.bind(null, admissionId)}
        valoresIniciales={{
          periodo,
          vencimiento: vencimientoSugerido(periodo, cuenta.due_day),
          importe: cuenta.monthly_fee.toFixed(2).replace(".", ","),
          notas: "",
        }}
      />
    </div>
