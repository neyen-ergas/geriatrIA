...
describe("semanas de agenda", () => {
  it.each(["2026-09-07", "2026-09-12", "2026-09-13"])(
    "normaliza %s de lunes a domingo",
    fecha => {
  ...
  it.each([undefined, ["2026-01-01"], "2026-02-30", "basura", "9999-12-31"])(
    "recupera la semana actual ante parámetros inválidos o fuera de rango: %s",
    valor => {
      expect(semanaAgenda(valor, "2026-09-12").inicio).toBe("2026-09-07");
    },
  );
  it("conserva días al cruzar el año y el 29 de febrero", () => {
    expect(semanaAgenda("2026-01-01", "2026-09-12")).toMatchObject({
      inicio: "2025-12-29",
      fin: "2026-01-04",
    });
